...
?>
	  <table border="0" cellpadding="2" cellspacing="0" bgcolor="#FFFFFF">
			 ...
			 <tr class="dataTableContent">
                     ...
                     <?php  echo tep_draw_input_field('admin_email_address',$myAccount['admin_email_address'],'size="40"','onkeyup="javascript: document.getElementById(\'wrong_email\').style.display=\'none\';"'). '&nbsp;' ?>
					 </td>
...
?>
            <table border="0" width="100%" cellspacing="0" cellpadding="10" align="center">
			  ...
			  <tr>
				<td id="load" class="dataTablecontent" style="display:none">
				<?php echo "Loading............";?>
				</td>
			 </tr>	
			  <Tr class="dataTableContent" id="thanx" style="display:none;">
						<td class="dataTableContent" align="left">
						<?php echo '<font color=green size="2"><b>' . PASSWORD_CHANGED_SUCCESFULLY . tep_draw_separator('pixel_trans.gif','10','10') . '</font></b>'?></td>
			  </Tr>
			    <tr class="dataTableRow">
                <td>
                  <table border="0" cellspacing="0" cellpadding="5" id="show">
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="2"><tr><td class="smallText" valign="top"><?php echo TEXT_INFO_MODIFIED . $myAccount['admin_modified']; ?></td><td align="right"><?php if ($FREQUEST->getvalue('action') == 'edit_process') { echo '<a href="' . tep_href_link(FILENAME_ADMIN_ACCOUNT) . '">' . tep_image_button('button_back.gif', IMAGE_BACK) . '</a> '; if ($FSESSION->is_registered('confirm_account')) { echo tep_image_submit('button_save.gif', IMAGE_SAVE, 'onClick="validateForm();return document.returnValue"'); } } elseif ($FREQUEST->getvalue('action') == 'check_account') { echo '&nbsp;'; } //else { echo tep_image_submit('button_edit.gif', IMAGE_EDIT); } ?></td></tr></table>
