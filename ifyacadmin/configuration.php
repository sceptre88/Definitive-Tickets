...
/*					else
	...
	<style>
		...
		?>							<table border="0" width="100%" cellspacing="0" cellpadding="0">
								...
								if($mPath=='7_433'){ ?>
								<tr>
									<td class="config_title_line">&nbsp;<?php //echo MAILERLITE; ?>&nbsp;<a href="https://clicky.com/100806147"><img src="images/clicky750x100.gif" align="absmiddle"/></a></td>
								</tr>
								<tr>
									<td>
										<table width="100%" cellpadding="1" cellspacing="1">
											<tr>
												<td class="config_title_line" width="100%">&nbsp;<?php echo CLICKY_SUB; ?></td>
											</tr> 
											<tr>
												<td width="100%" class="main" align="justify">&nbsp;<?php  echo CLICKY_TEXT;?></td>
											</tr>
										</table>	  	
									</td>
								</tr>	
								...
								if($mPath=='7_434'){ ?>
								<tr>
									<td class="config_title_line">&nbsp;<?php //echo MAILERLITE; ?>&nbsp;<a href="https://dash.cookiehub.com/register?al=61068573"><img src="images/cookiehub750x100.gif" align="absmiddle"/></a></td>
								</tr>
								<tr>
									<td>
										<table width="100%" cellpadding="1" cellspacing="1">
											<tr>
												<td class="config_title_line" width="100%">&nbsp;<?php echo COOKIEHUB_SUB; ?></td>
											</tr> 
											<tr>
												<td width="100%" class="main" align="justify">&nbsp;<?php  echo COOKIEHUB_TEXT;?></td>
											</tr>
										</table>	  	
									</td>
								</tr>	
