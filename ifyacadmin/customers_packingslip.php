...
<tr>
	...
	<?php 
			...
			$products_ordered='<tr><td colspan="2" class="main"><table border="0" width="100%" cellspacing="0" cellpadding="1" bgcolor=#000000>'.
									'<tr>' .
			...
			for ($i = 0, $n = sizeof($order->products); $i < $n; $i++) {
			  ...
			  $products_ordered.=' </td>'  .
								   '<td class="dataTableContent" valign="top">' . $order->products[$i]['concert_date'] . ' ' . $order->products[$i]['concert_time'] . '</td>' .
								   '</tr>' ;
			}
