...
define('FILENAME_CURRENCIES', '');
define('ERROR_TITLE_EMPTY', '');
define('ERROR_CODE_EMPTY', '');
define('ERROR_SYMBOL_LEFT', '');
define('ERROR_DECIMAL_POINT', '');
define('ERROR_THOUSANDS_POINT', '');
define('ERROR_DECIMAL_PLACES', '');
define('ERROR_CURRENCY_VALUE', '');
define('ERROR_NUMERIC_VALUE', '');
