...
//	$input_params=&$HTTP_GET_VARS;
   ...
   $display_header="";
	...
	$payment_col_count=0;
			...
			$unique_payment_sql="SELECT distinct payment_method from " . TABLE_ORDERS . " o, " . TABLE_ORDERS_PRODUCTS . " op where o.orders_id=op.orders_id  " . $where . $prd_where. " and o.orders_status=5 order by o.payment_method";
