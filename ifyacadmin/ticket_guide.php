...
<p>For the best quality, upload hi res images via your server file manager/FTP account to the /images/ directory</p>
...
<p><h3>GUIDE TO PLACEHOLDERS:</h3><br />
  [[Concert Name]] = Concert Heading Titles<br />
  [[Concert Venue]] = Venue<br />
  [[Concert Date]] = Date of the event<br />
  [[Concert Time]] = Time of the event<br />
  </p>
<p>[[Discount Type]] = Type of discount added<br />
  [[Coupon]] = If Coupon Discount used or not, if so it will print 'Coupon Discount'<br /> 
[[Concert Price]] = Price of ticket with currency</p>
<p>[[Customers Name]] = Customers fullname taken from the actual order.<br />
</p>
<p>[[Products Name]] = Seat Name and Number or whatever the name of your product<br />
...
<p>NEW! [[Ticketholder Name]] = Ticket Holder Name if enabled</p>
...
<p>For customer conveniance PDF eTickets when generated are stored on the server. From time to time you will need to clear out the <strong>PDF Event Tickets</strong> and <strong>Ticket Bar PNG</strong> as they are generated in the /images/tickets folder and may use unnecessary  webspace over time.<br />
