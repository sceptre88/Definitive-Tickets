...
?>
			...
			<?php		} else if ($type=='startdiv') { ?>
                       ...
                       #1 add the field name to the SQL (line 189)
                        ...
                        <td class='dataTableHeadingTitleContent' width="225"><?php echo TEXT_SHOW;?></td>
	...
	function generate_pdf(){
		...
		for ($icnt=0;$icnt<sizeof($output_array);$icnt++) {
			...
			if ($type=='head'){
				...
				$cols[]=array("text"=>TEXT_SHOW,"width"=>$widths[7],"align"=>"L","style"=>"headrow","valign"=>"M");
		...
		for ($icnt=0;$icnt<sizeof($output_array);$icnt++) {
			...
			if ($type=='head'){
				if($report_display_header==strtolower($element['content'])){
					...
					$result.="" . TEXT_SEATS . "\n";
					$result.=TEXT_ID . "," . SEAT_NAME . "," . ORDER_ID . "," . TICKET_ID . "," . TICKET_PRINTED . "," . DATE_ID . "," . TEXT_SHOW . "," . TEXT_CUSTOMER . "," . TEXT_BILLING_NAME . "," . TEXT_QTY . "," . TEXT_STATUS . "," . TEXT_PAYMENT . "," . TEXT_AMOUNT . "\n";
				} else{
					$report_display='reject';
				}
			} else if (($type==$sub) && ($report_display=='accept')){//
			...
			///////////////////////////////////////////////////////////////////////////////////////////
				...
				//Code change RM 
				//$result.=SEAT . "," . ORDER_ID . "," . TICKET_ID . "," . DATE_ID . "," . TEXT_CUSTOMER . "," . TEXT_BILLING_NAME . "," . TEXT_QTY . "," . TEXT_STATUS . "," . TEXT_AMOUNT . "\n";
			//} else if (($type=='item') && ($report_display=='accept')){
				//$result.=$element["content"] . "\n";
			} else if (($type=='row') && ($report_display=='accept')){
