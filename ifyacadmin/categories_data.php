<?php
	...
	*/
	...
	define('HEADING_TITLE', 'Catgories Data');
...
<title><?php echo TITLE; ?></title>
	...
	<script type="text/javascript" charset="utf-8" src="datatables/js/table.categories_data.js"></script>
...
<body  class="categories_data" marginwidth="0" marginheight="0" topmargin="0"  leftmargin="0" bgcolor="#FFFFFF">
...
<!-- header_eof //-->
		...
		{
		?>
		<div class="osconcert_message"><?php echo CATEGORIES_DATA; ?></div>
		<?php
		}
		?>
<!-- body //-->
	<div class="container-fluid" style="padding:10px">
		...
		?>
			<table cellpadding="0" cellspacing="0" border="0" class="display" id="categories" width="100%">
				<thead>
					<tr>
						<th>Categories ID</th>
