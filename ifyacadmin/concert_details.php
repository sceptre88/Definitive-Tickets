...
<html <?php echo HTML_PARAMS; ?>>
	<head>
		...
		?>
        <div>
		<a class="btn btn-primary" href="products_only_data.php">Products TABLE Data</a>
		<a class="btn btn-primary" href="orders_only_data.php">Orders TABLE Data</a>
		<a class="btn btn-primary" href="orders_history.php">Orders Status History TABLE Data</a>
		</div><br>
		<?php
		}
		...
		if(ALLOW_CATEGORY_EXPIRY=='yes'){
			echo '<div style="float:left;color:red;"><b>' . TEXT_EXPIRY_TRUE.  '</b></div>';
		}
