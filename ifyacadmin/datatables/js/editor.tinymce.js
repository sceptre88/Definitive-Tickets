		...
		this
			.on( 'open.tinymceInit-'+conf._safeId, function () {
				tinymce.init( $.extend( true, {
					...
					width : 760,
					visual: true,
					plugins: 'code lists autolink lists link image charmap print preview hr anchor pagebreak',
					toolbar: 'undo redo styleselect bold italic alignleft aligncenter alignright bullist numlist outdent indent code insertfile | link image | print preview media fullpage',
					relative_urls : false,
