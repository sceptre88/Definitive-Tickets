...
Editor::inst( $db, 'products_description', 'products_id' )
	->fields(
		...
		Field::inst( 'products.products_x' ),
		Field::inst( 'products.products_y' ),
		Field::inst( 'products.products_w' ),
		Field::inst( 'products.products_h' ),
		Field::inst( 'products.products_status' ),
		Field::inst( 'products.products_r' ),
		Field::inst( 'products.products_sx' ),
		Field::inst( 'products.products_sy' ),
		...
		Field::inst( 'products_description.products_number' ),
