...
define('TEXT_TYPE_AUT', '');
define('TEXT_TYPE_AUR', '');
define('TEXT_TYPE_CUS', '');
define('TEXT_TYPE_CUX', '');
define('TEXT_TYPE_CUR', '');
define('TEXT_TYPE_APV', '');
define('TEXT_TYPE_ADM', '');
define('TEXT_TYPE_OSU', '');
define('TEXT_TYPE_OAR', '');
define('TEXT_TYPE_ACU', '');
define('TEXT_TYPE_MIV', '');
define('TEXT_TYPE_CON', '');
define('ERR_EMPTY_SUBJECT', '');
define('ERR_EMPTY_REPLY_TO', '');
define('ERROR_CUSTOMER_ADDRESS', '');
define('TEXT_LOADING', '');
...
define('ERR_INVALID_REPLY_TO', '');
define('UPDATE_ORDER', '');
define('TEXT_UPDATE_ORDER', '');
define('PRD_DELETING', '');
define('TEXT_PRD_DELETING', '');
define('ERR_EMPTY_TITLE', '');
define('TEXT_IMPORTANT', '');
define('TEXT_ALL_CUSTOMERS', '');
define('TEXT_NEWSLETTER_CUSTOMERS', '');
define('TEXT_MESSAGE_DELETE_SUCCESS', '');
define('TEXT_DELETE_INTRO', '');
define('FIRST_MENU_DISPLAY', '');
define('IMAGE_SEND_ALL_CUSTOMERS', '');
define('TEXT_SELECT_CUSTOMER', '');
define('TEXT_MERGE_FIELDS', '');
define('TEXT_CREATE_PWD', '');
define('IMAGE_SEND_EMAIL', '');
define('TEXT_BEFORE_REGISTER', '');
define('TEXT_AFTER_REGISTER', '');
define('TEXT_INVOICE_TITLE', '');
define('TEXT_CONTACT_US_TITLE', '');
define('TEXT_LETTER_TITLE', '');
define('TEXT_CONTACT_US_TEXT', '');
define('TEXT_LETTER_TEXT', '');
define('TEXT_PACKING_SLIP_TITLE', '');
define('TEXT_PACKING_SLIP_TEXT', '');
define('TEXT_MESSAGE_SUBJECT', '');
define('TEXT_MESSAGE_REPLY_TO', '');
define('TEXT_MESSAGE_TEXT', '');
define('INFO_MESSAGE_TEXT', '');
define('TEXT_MESSAGE_FORMAT', '');
	...
	$fields_details['N']=array(array('id'=>'TITLE_N','text'=>TEXT_TITLE_N),
		...
		array('id'=>'TM','text'=>'&nbsp;&nbsp;' . 'TEXT_TM')
			...
			$fields_type['CUR']='C'; //osConcert Password Remember
