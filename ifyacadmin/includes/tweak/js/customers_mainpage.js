            ...
            // {
                ...
                // {
                   // name=element.name.split('_');
                        // if(!name[2])
                            // name[2]='';
                   // fieldDesc["error_text"]='Your Telephone Number must contain numeric values or contain no spaces';/*name[1]+' '+name[2]+' number should contain numeric values or contain no spaces'*/;
                // pass=false;
                // }
            // }
