...
define('TEXT_MN', '');
define('TEXT_BUN', '');
define('TEXT_GROUP_DELETE_SUCCESS', '');
define('TEXT_CUSTOMER_GROUPS_NOT_DELETED', '');
define('TEXT_INFO_DELETE_INTRO', '');
define('PRD_DELETING', '');
define('TEMPLATE_TIC', '');
define('UPDATE_RESULT', '');
define('ALTERNATE_ROW_STYLE', '');
define('ROW_CLICK_GET', '');
define('FIRST_MENU_DISPLAY', '');
define('TEXT_EMPTY_GROUPS', '');
define('TEXT_INFO_HEADING_NEW_LANGUAGE', '');
define('TEXT_TEMPLATE_NAME', '');
define('TEXT_FN', '');
define('TEXT_LN', '');
define('TEXT_SD', '');
define('TEXT_ALIGN_LEFT', '');
define('TEXT_ALIGN_RIGHT', '');
define('HEAD_NAME', '');
define('TEXT_SIZE', '');
define('TEXT_TEMPLATE_WIDTH', '');
define('TEXT_DIMENSION', '');
define('TEXT_TEMPLATE_HEIGHT', '');
define('TEXT_SHOP_LOGO', '');
define('TEXT_IMAGE', '');
define('TEXT_IMG', '');
define('TEXT_POSITION_BGIMG', '');
define('TEXT_POSITION', '');
define('TEXT_SERVICE_CONDITION', '');
define('TEXT_EVENT_CONDITION', '');
define('TEXT_SERVICE_DETAILS', '');
define('TEXT_EVENT_DETAILS', '');
define('TEXT_CONTENT', '');
define('TEXT_OSCONCERT', '');
define('TEXT_INFO_LANGUAGE_DIRECTORY', '');
define('TEXT_TIC', '');
define('TEXT_TICS', '');
define('ENT_EQUIPMENT', '');
define('EQUIPMENT', '');
define('ENT_CONTACT', '');
define('ENT_SEATS', '');
define('TEXT_LOCATION_MAX_SEATS', '');
define('UPDATE_DATA', '');
define('UPDATE_IMAGE', '');
...
<?php
		...
		function doList($where='',$group_id=0,$search=''){
			...
			$query_split=false;
    	 	...
    	 	$customers_groups_sql="select * from " . TABLE_GENERAL_TEMPLATES . " order by template_id";			
			...
			if($found){
				...
				if($customers_groups_result["template_type"]=='TIC3'){
				$template_name=" :: " . TEMPLATE_TIC3;
				}
				if($customers_groups_result["template_type"]=='TIC2'){
				$template_name=" :: " . TEMPLATE_TIC2;
				}
				if($customers_groups_result["template_type"]=='TIC'){
				$template_name=" :: " . TEMPLATE_TIC;
				}
				if($customers_groups_result["template_type"]=='TIC4'){
				$template_name=" :: " . TEMPLATE_TIC4;
				}
				if($customers_groups_result["template_type"]=='TIC5'){
				$template_name=" :: " . TEMPLATE_TIC5;
				}
				
				if($customers_groups_result["template_id"]==TICKET_TEMPLATE){
					
				}
	
					$rep_array=array(	"ID"=>$customers_groups_result["template_id"],
										"TYPE"=>$this->type,
										"NAME"=>$customers_groups_result["template_id"],
										"ID_TYPE"=>$customers_groups_result["template_type"],
										"DISCOUNT"=>$customers_groups_result["template_type"].' '.$template_name,
							...
							<td valign="top">
								<table border="0" cellpadding="0" cellspacing="0" width="100%">
									<tr  >
										...
										<b><?php echo  TEXT_TEMPLATE_NAME;?> <span class="red">CURRENT DEFAULT: <?php echo  TICKET_TEMPLATE;?></span></b>
										</td>
										<td class="main">&nbsp;
		...
		<?php if (is_object($this->splitResult)){?>
			...
			<table border="0" cellpadding="0" cellspacing="0" width="100%" class="productEditCol">
				...
				<td><?php
					...
					<tr>
						<td class="main" colspan="2"><?php echo TEXT_SHOP_LOGO;  ?></td>
					</tr>
					<tr>
					...
					<tr>
						<td class="main" colspan="2"><?php echo TEXT_IMG;  ?>
						
						<div class="container-fluid">
	<div class="row" style="width:500px">
		<div class="col-md-6" style="float:left;"><img width="200px" src="images/ticket_l_example.png">
		</div>
		<div class="col-md-6"  style="float:right;"><img width="200px" src="images/ticket_r_example.png">
		</div>
	</div>
</div>
						...
						<tr>
							<td class="main"><?php echo TEXT_POSITION_BGIMG; ?></td>
					...
					<Td class="main">
					<?php echo tep_draw_pull_down_menu('merge_fields',$merge_fields,'','size=6 style="height:250" onDblClick="javascript:AddField(\'event_details_content\');"'); 
						?>
						</Td>
					</tr>
					<tr>
