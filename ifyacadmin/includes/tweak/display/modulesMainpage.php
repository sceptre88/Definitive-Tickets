...
define('MODULE_SHIPPING_', '');
define('HEADING_TITLE', '');
define('HEADING_TITLE_MODULES_SHIPPING', '');
define('MODULE_ORDER_TOTAL_', '');
define('HEADING_TITLE_MODULES_ORDER_TOTAL', '');
define('MODULE_SMS_GATEWAYS_INSTALLED', '');
define('MODULE_SMS_', '');
define('MODULE_SMS_INSTALLED', '');
define('HEADING_TITLE_MODULES_SMS_GATEWAYS', '');
define('MODULE_PAYMENT_', '');
define('HEADING_TITLE_MODULES_PAYMENT', '');
define('DELETING_MODULE', '');
define('TEXT_DELETING_MODULE', '');
define('SORTING_DATA', '');
define('TEXT_SORTING_DATA', '');
define('DIR_FS_CATALOG', '');
define('DIR_FS_ADMIN', '');
define('TEXT_INSTALLING_MODULE', '');
define('IMAGE_INSTALL', '');
define('IMAGE_ELEMENT', '');
define('TEXT_KEY_NOT_FOUND', '');
define('UPDATE_IMAGE', '');
define('UPDATE_DATA', '');
