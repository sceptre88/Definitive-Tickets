...
class shopTemplateConfiguration
{
	...
	function doUpdate()
		...
		$howto = $FREQUEST->postvalue('howto');
		$show_footer = $FREQUEST->postvalue('show_footer');
	...
	global $SERVER_DATE,$FREQUEST;
		...
		if($default_template_id>0)
		{
			...
			$sql_data_array = array('template_name' => $template_name,
							...
							'howto' =>  $template_result["howto"],
							'show_page_login' =>  $template_result["show_page_login"],
							'show_footer' => $template_result["show_footer"],
				  ...
				  <?php 
					if ($handle = opendir(DIR_FS_TEMPLATES)) 
					{
					 ...
					 // if(count($dirs_array) == 0)
						  if (is_countable($dirs_array) && count($dirs_array) == 0) 
					  {
					  ...
					  else
					  {
						...
						if (is_countable($dirs_array) && count($dirs_array) > 0) {
						//PHP8 !! Uncaught TypeError: sort(): Argument #1 ($array) must be of type array, null given
						sort($dirs_array);
	...
	function doEdit() 
	{
		...
		<table border="0" cellpadding="0" cellspacing="0" width="100%" >
  			<tr>
   				<td width="100%" valign="top" class="smalltext">
					...
					if($tInfo->template_id==6)
					{
					$colours_available = array('default'=>'default',
											   'green'=>'green',
											   'blue'=>'blue',
											   'red'=>'red',
											   'valencia'=>'valencia',
		...
		<table border="0" cellpadding="5" cellspacing="0" width="99%" >
					...
					<td class="smalltext" width="10%" nowrap><?php echo TEXT_SHOW_LOGIN; ?></td>
      						<td class="smalltext" width="20%" id="bullet_show_page_login">
									 <?php
									  if ($tInfo->show_page_login == 'yes') 
									  {
											echo '<a href="javascript:void(0)" onclick="javascript:doSimpleAction({id:'. $tInfo->template_id .",get:'change_template_button_status',result:doSimpleResult,params:'tID=". $tInfo->template_id . "&status=no&case=show_page_login',message:'".TEXT_UPDATING_STATUS."'});\">" . tep_image(DIR_WS_IMAGES . 'template/icon_active.gif') . '</a>';
									  } else 
									  {
											echo '<a href="javascript:void(0)" onclick="javascript:doSimpleAction({id:'. $tInfo->template_id .",get:'change_template_button_status',result:doSimpleResult,params:'tID=". $tInfo->template_id . "&status=yes&case=show_page_login',message:'".TEXT_UPDATING_STATUS."'});\">" . tep_image(DIR_WS_IMAGES . 'template/icon_inactive.gif') . '</a>';
									  }
									?>
							
      						
       						</td>
							<td class="smalltext" width="10%" nowrap><?php echo TEXT_SHOW_HOWTO; ?></td>
      						<td class="smalltext" width="20%" id="bullet_howto">
									 <?php
									  if ($tInfo->howto == 'yes') 
									  {
											echo '<a href="javascript:void(0)" onclick="javascript:doSimpleAction({id:'. $tInfo->template_id .",get:'change_template_button_status',result:doSimpleResult,params:'tID=". $tInfo->template_id . "&status=no&case=howto',message:'".TEXT_UPDATING_STATUS."'});\">" . tep_image(DIR_WS_IMAGES . 'template/icon_active.gif') . '</a>';
									  } else 
									  {
											echo '<a href="javascript:void(0)" onclick="javascript:doSimpleAction({id:'. $tInfo->template_id .",get:'change_template_button_status',result:doSimpleResult,params:'tID=". $tInfo->template_id . "&status=yes&case=howto',message:'".TEXT_UPDATING_STATUS."'});\">" . tep_image(DIR_WS_IMAGES . 'template/icon_inactive.gif') . '</a>';
									  }
									?>
       						</td>
      				   </tr>
     				   ...
     				   <tr>
        					<td class="smalltext" width="10%" nowrap><?php echo TEXT_SHOW_FOOTER; ?></td>
      						<td class="smalltext" width="20%" id="bullet_show_footer">
									 <?php
									  if ($tInfo->show_footer == 'yes') 
									  {
											echo '<a href="javascript:void(0)" onclick="javascript:doSimpleAction({id:'. $tInfo->template_id .",get:'change_template_button_status',result:doSimpleResult,params:'tID=". $tInfo->template_id . "&status=no&case=show_footer',message:'".TEXT_UPDATING_STATUS."'});\">" . tep_image(DIR_WS_IMAGES . 'template/icon_active.gif') . '</a>';
									  } else 
									  {
											echo '<a href="javascript:void(0)" onclick="javascript:doSimpleAction({id:'. $tInfo->template_id .",get:'change_template_button_status',result:doSimpleResult,params:'tID=". $tInfo->template_id . "&status=yes&case=show_footer',message:'".TEXT_UPDATING_STATUS."'});\">" . tep_image(DIR_WS_IMAGES . 'template/icon_inactive.gif') . '</a>';
									  }
									?>
		  ...
		  <td class="smalltext" nowrap> <?php echo TEXT_SPONSORS;?></td>
		                     <td class="smalltext" id="bullet_header_banner"><?php 
									  if ($tInfo->header_banner == 'yes') 
									  {
											echo '<a href="javascript:void(0)" onclick="javascript:doSimpleAction({id:'. $tInfo->template_id .",get:'change_template_button_status',result:doSimpleResult,params:'tID=". $tInfo->template_id . "&status=no&case=header_banner',message:'".TEXT_UPDATING_STATUS."'});\">" . tep_image(DIR_WS_IMAGES . 'template/icon_active.gif') . '</a>';
									  } else 
									  {
											echo '<a href="javascript:void(0)" onclick="javascript:doSimpleAction({id:'. $tInfo->template_id .",get:'change_template_button_status',result:doSimpleResult,params:'tID=". $tInfo->template_id . "&status=yes&case=header_banner',message:'".TEXT_UPDATING_STATUS."'});\">" . tep_image(DIR_WS_IMAGES . 'template/icon_inactive.gif') . '</a>';
									  }
								?>
      						 </td>
