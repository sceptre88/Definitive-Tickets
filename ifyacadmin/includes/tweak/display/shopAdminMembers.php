...
define('ENT_DESCRIPTION', '');
define('TABLE_HEADING_ZONE_DESCRIPTION', '');
define('FIRST_MENU_DISPLAY', '');
define('ENT_EMAIL', '');
define('ENT_GROUP', '');
define('TEXT_GROUP_LEVEL', '');
define('ENT_ACCOUNT', '');
define('TEXT_INFO_FIRSTNAME', '');
define('TEXT_INFO_LASTNAME', '');
define('TEXT_LOCATION_NOT_FOUND', '');
define('TEXT_RECORDS', '');
define('INFO_LOADING_COUNTRY', '');
define('UPDATE_RESULT', '');
define('ALTERNATE_ROW_STYLE', '');
define('ROW_CLICK_GET', '');
define('TEXT_NEW_NEWS', '');
define('SEARCH_NEEDED', '');
define('UPDATING_ORDER', '');
define('TEXT_UPDATING_ORDER', '');
define('STATUS_STICKY', '');
define('EDIT_MENU_DISPLAY', '');
define('FLAG_ONE_RECORD', '');
define('HEADING_NEW_NEWS', '');
define('TEXT_ALL', '');
define('TEXT_SHOW', '');
define('INFO_LOADING_PRODUCTS', '');
define('TEXT_CATEGORY_DELETED_SUCCESS', '');
define('TEXT_INSTRUCTOR_OPTIONS_NOT_DELETED', '');
define('TEXT_DELETE_CATEGORY_INTRO', '');
define('TEXT_DELETE_WARNING_CHILDS', '');
define('BULLET_IMAGE', '');
define('HEADING_NEW_TITLE', '');
define('INFO_LOADING_ZONES', '');
define('PAD_LEFT', '');
define('CAT_PARENT', '');
define('UPDATE_DATA', '');
define('UPDATE_IMAGE', '');
