		...
		function doCustomersList($search='',$order,$page='') 
		{
			...
			if($found)
			{
				...
				{						
					...
					$customers_guest=$customers_detail_result['guest_account'];
					...
					if ($customers_guest == 1){
							$table_style = ' style="background-color:palegreen"';
						}else{
							$table_style = '';
					}
 		...
 		<table border="0" cellpadding="4" cellspacing="0" width="100%">
			...
			<td>&nbsp;</td>
  			...
  			<tr>
    			...
    			<td width="25%" align="left" style="overflow:hidden"  class="main">(##ID##) <b>##ACCOUNTCRT##</b>&nbsp;&nbsp;<b>##DATECRT##</b></td>
