...
define('TEXT_SEARCH_RESULTS', '');
define('TEXT_NO_RECORDS_FOUND', '');
...
define('TEXT_INFO_HEADING_NEW_CURRENCY', '');
define('CURRENCY_SERVER_PRIMARY', '');
define('TABLE_HEADING_CURRENCY_NAME', '');
define('TABLE_HEADING_CURRENCY_CODES', '');
define('TABLE_HEADING_CURRENCY_VALUE', '');
define('HEAD_NAME', '');
define('TEXT_INFO_CURRENCY_TITLE', '');
define('TEXT_INFO_CURRENCY_CODE', '');
define('TEXT_INFO_CURRENCY_SYMBOL_LEFT', '');
define('TEXT_INFO_CURRENCY_SYMBOL_RIGHT', '');
define('TEXT_INFO_CURRENCY_DECIMAL_POINT', '');
define('TEXT_INFO_CURRENCY_THOUSANDS_POINT', '');
define('TEXT_INFO_CURRENCY_DECIMAL_PLACES', '');
define('TEXT_INFO_CURRENCY_VALUE', '');
define('CURRENCY_SERVER_BACKUP', '');
define('WARNING_PRIMARY_SERVER_FAILED', '');
define('TEXT_INFO_CURRENCY_UPDATED', '');
define('ERROR_CURRENCY_INVALID', '');
...
define('SEATS', '');
define('TEXT_LOCATION_NOT_FOUND', '');
define('UPDATE_DATA', '');
define('UPDATE_IMAGE', '');
...
<?php
		...
		function doDeleteGroups(){
			...
			<form  name="<?php echo $this->type;?>DeleteSubmit" id="<?php echo $this->type;?>DeleteSubmit" action="shop_languages.php" method="post" enctype="application/x-www-form-urlencoded">
		...
		<?php if (is_object($this->splitResult)){?>
			...
			?>
				...
				<table border="0" cellpadding="4" cellspacing="0" width="100%">
					<tr>
						<td valign="top">
							<form action="shop_languages.php" method="post" name="customer_groups" enctype="multipart/form-data" id="customer_groups">
