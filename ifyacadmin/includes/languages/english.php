...
<h4>If you see text colors <span class="red">RED</span> or <span class="blue">BLUE</span> here for live GREEN buttons....there maybe a problem (a bad reset?). Please correct the status by clicking to RED button and then back to GREEN button.</h4>');
...
define('PRODUCTS_DATA', '<h5>Data from the TABLE products and products_description</h5>');
define('PRODUCTS_ONLY_DATA', '<h5>Data from the TABLE products</h5>');
define('BARCODE_DATA', '<h5>Data from the TABLE orders_barcode</h5>');
define('ORDERS_HISTORY_DATA', '<h5>Data from the TABLE orders_status_history</h5>');
define('ORDERS_DATA', '<h5>Data from the TABLE orders</h5>');
define('CATEGORIES_DATA', '<h5>Data from the TABLE categories and categories_description</h5>');
define('DESIGN_DATA', '<h5>Data from the TABLE products relating to the design mode</h5>');
...
define('WARNING_SEATPLAN_CACHE_DISABLED','<a target="_blank" href="https://www.osconcert.com/faq/index.php?solution_id=1038">Seatplan caching</a> is currently disabled - this is recommended for editing/testing purposes ONLY. Enable Seatplan caching when you go LIVE!');
...
define('DETAILS','Details<br>Refunds are for your osConcert reference only. Be sure to refund credit card orders at your Payment Gateway dashboard.');
...
define('TEXT_EXPIRY_TRUE','WARNING: Event categories are set to expire. See <a class="help_links"  href="configuration.php?gID=929&mPath=4_46_432&top=1">Event Expiry</a> settings');
//eticket
define("TEXT_FOR"," for: ");

define("TEXT_INFO_PAYMENT_COMMENTS"," Customers Comments: ");
define('COOKIEHUB','');
define('COOKIEHUB_SUB','Cookie compliance made simple!');
define('COOKIEHUB_TEXT','CookieHub is a fully featured Consent Management Platform (CMP), providing everything you need to make your web site GDPR, LGPD and CCPA compliant.');


define('CLICKY','<a href="https://clicky.com/100806147"><img border="0" title="Privacy update: Cookie-free tracking is the new default" alt="Privacy update: Cookie-free tracking is the new default" src="images/mailerlite750x100.gif" width="750" height="100" /></a>');
define('CLICKY_SUB','<a href="https://blog.clicky.com/cookie-free-privacy-friendly-tracking-web-analytics/">Cookie-free tracking is the new default</a>');
define('CLICKY_TEXT','Copy the number from your Clicky Tracking Code and put it in the form below: <br>async src="//static.getclicky.com/<span class="red">000000000</span>.js"></script>');
...
define('TEXT_NO_DETAILS_FOUND', 'No Details Found or this product is NOT printable');
?>