...
define('TEXT_OSCONCERT_MESSAGE', 'BOX OFFICE: Create Box Office users here. Select Country=Box Office ...they will appear as red color in the list of customers below. <br>To show all Box Office Users <span class="red">SEARCH= 999</span> in the search box above<br><br>
<span style="color:palegreen">Green color</span> means customers who purchased WITHOUT account.');
