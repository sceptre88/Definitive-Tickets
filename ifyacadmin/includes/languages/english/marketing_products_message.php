...
define('HEADING_TITLE','Product Messages');
//define('TEXT_HEADING_TITLE', 'Email Messages');
define('TEXT_HEADING_TITLE', 'Product Messages');
define('TEXT_HEADING_PREVIEW','Preview Mail Template');

define('ORDR_PD','');
define('TEXT_P_STATUS','');
define('TEXT_PN','');
define('TEXT_PP','');
define('TEXT_P_Q','');
define('TEXT_PA','');
...
define('TEXT_TYPE_REM','Products Reminders');
define('TEXT_TYPE_PST','Products Status Change');
define('TEXT_TYPE_PSP','Products Packing Slip');
define('TEXT_TYPE_PRS','Products Sent');
define('TEXT_TYPE_PRE','Payment Received');
...
define('TEXT_TITLE_P','Product details');
define('TEXT_TITLE_C','Order Details');
...
define('NOTICE_EMAIL_SENT_TO','Mail successfully sent to all customers');
...
define('IMAGE_SEND_ALL_CUSTOMERS','Send to all customers');
define('TEXT_SEND_CONFIRM','Are you sure to send mail to all customers?');
...
define('TEXT_TEST_MAIL_INTRO','Do you want to send Test Mail?');
define('TEXT_DELETE_PAGE_INTRO','Are you sure to Delete this Message?');
...
define('TEXT_EMAIL_DELETE_SUCCESS','Email Message Deleted Successfully');
define('TEXT_TEST_MAIL_SENT_SUCCESS','Test Email Sent Successfully');
//v
