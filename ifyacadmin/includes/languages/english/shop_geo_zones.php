...
define('TABLE_HEADING_ZONE_DESCRIPTION','Zone Description');
define('ERR_TEXT_ZONE_NAME','Please Enter Zone Name');
define('ERR_TEXT_ZONE_DESCRIPTION','Please Enter Zone Description');
define('TEXT_WARNING_OF_DELETE','This zone has countries. You can\'t able to delete');
define('HEADING_TITLE_GOTO','Go To');

define('EMPTY_OPTION_VALUE', 'Please Select Country Name');
define('HEADING_NEW_TITLE','New Zones');
//define('TEXT_RECORDS','tax zones');
define('TEXT_LOADING_DATA','Loading data...');
define('UPDATE_DATA','Update...');
define('TEXT_INFOBOX_DELETE_SUCCESS','Infobox erfolgreich gelöscht');
define('TEXT_INFOBOX_NOT_DELETED','Infobox nicht gelöscht');
define('TEXT_UPDATE_ORDER','Updating...');
define('TEXT_SORTING_DATA','Infoboxen sortieren...');
define('TEXT_PRD_DELETING','Deleting...');
define('INFO_LOADING_ZONES','Loading Zones...');
define('TEXT_NEW_COUNTRY','New Country');
define('TEXT_SHOW','Show');
define('TEXT_ALL','All');

define('TEXT_ZONES_DELETE_SUCCESS','Zone Deleted Successfully');
define('TEXT_COUNTRY_DELETE_SUCCESS','Country Deleted Successfully');
define('TEXT_EMPTY_ZONES','No Zones Found');
define('INFO_LOADING_COUNTRY','Loading Country...');
