...
*/
		...
		define("MODULE_PAYMENT_STRIPESCA_IMAGE", '');
		define("MODULE_PAYMENT_STRIPESCA_TEXT_DESCRIPTION", '');
		define("MODULE_PAYMENT_STRIPESCA_SORT_ORDER", '');
		define("MODULE_PAYMENT_STRIPESCA_STATUS", '');
		define("MODULE_PAYMENT_STRIPESCA_TESTMODE", '');
		define("MODULE_PAYMENT_STRIPESCA_LIVE_PUBLISHABLE_KEY", '');
		define("MODULE_PAYMENT_STRIPESCA_LIVE_SECRET_KEY", '');
		define("MODULE_PAYMENT_STRIPESCA_ORDER_STATUS_ID", '');
