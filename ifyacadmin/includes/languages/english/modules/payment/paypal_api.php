...
defined('_FEXEC') or die();
	...
	define('MODULE_PAYMENT_PAYPAL_API_IMAGE', '');
	...
	define('MODULE_PAYMENT_PAYPAL_API_TEST_MODE', '');
	define('MODULE_PAYMENT_PAYPAL_API_ID', '');
	define('MODULE_PAYMENT_PAYPAL_API_SECRET', '');
	define('MODULE_PAYMENT_PAYPAL_API_ADMIN', '');
	define('MODULE_PAYMENT_PAYPAL_API_TEXT_TITLE', '');
	define('MODULE_PAYMENT_PAYPAL_API_TEXT_TEXT_TITLE', 'Paypal');
