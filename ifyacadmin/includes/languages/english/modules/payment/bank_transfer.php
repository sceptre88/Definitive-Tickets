...
defined('_FEXEC') or die();
	...
	define('MODULE_PAYMENT_BANK_TRANSFER_ACCNUM','');
	define('MODULE_PAYMENT_BANK_TRANSFER_BSB','');
	define('MODULE_PAYMENT_BANK_TRANSFER_ACCNAM','');
	define('MODULE_PAYMENT_BANK_TRANSFER_BANKNAM','');
	define('MODULE_PAYMENT_BANK_TRANSFER_SWIFT','');

	
	define('MODULE_PAYMENT_BANK_TRANSFER_DISPLAY_NAME', 'Bank Transfer');
	define('MODULE_PAYMENT_BANK_TRANSFER_IMAGE', 'bank_transfer.png');
