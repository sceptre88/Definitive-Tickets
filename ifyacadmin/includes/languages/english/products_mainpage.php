...
define('ERR_PRODUCT_SEASON_EMPTY','Season Tickets Allocation should not be empty.');
...
define('TEXT_DESIGN_MODE_NO','<h4 class="red">Design Mode is NOT activated (<a href="configuration.php?mPath=400_419&top=1">Box Office Settings</a>)</h4>');
define('TEXT_DESIGN_MODE_YES','<h4 class="red">Design Mode is Activated<br>RE-EDIT for Design Space Background Image Options</h4>');
define('TEXT_EDIT_CATEGORIES_ADVANCE_FEE','Advanced Fee: (<a target="_blank" href="https://www.osconcert.com/faq/content/18/89/en/what-is-_advance-fee_-in-order-totals.html">What is this?</a>)');
define('TEXT_EDIT_CATEGORIES_ADVANCE_FEE','Gebühr für Fortgeschrittene: ');
define('PROMOTE_PRODUCT_SALE','Product Sales');
define('TEXT_SEASON','Season Tickets');
define('SEE_INVENTORY','View');
define('IMAGE_VIEW','View');

define('ERR_ATTRIB_VALUE_CANNOT_CHANGE','View');
define('ERR_ATTRIB_QUANTITY','View');
define('SKU_COUNT','View');
define('ERR_ATTRIB_SKU','View');
define('ERR_ATTRIB_STOCK_EXISTS','View');
define('ERR_ATTRIBUTE_SKU_EMPTY','View');
define('ERR_PRODUCT_ATTRIBUTES_STOCK_EMPTY','View');
define('PRD_ATTRIBUTES_COPYING','View');
define('TEXT_ATTRIBUTES_COPYING','View');
define('ERR_PRODUCT_ATTRIBUTES_EMPTY','View');
define('HEADING_PRICE', 'Price');
define('TEXT_IS_ATTRIBUTES','View');

define('HEADING_WIDTH','');
define('HEADING_HEIGHT','');
define('HEADING_ROTATE','');
define('HEADING_SCALE_X','');
define('HEADING_SCALE_Y','');
define('HEADING_X','');
define('HEADING_Y','');
