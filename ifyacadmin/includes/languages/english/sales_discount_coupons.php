...
define('INFO_LOADING_SALES_COUPONS','');

define('HEADING_TITLE','Discount Coupons');
define('COUPONS_REPORT','<a href="reports_discount_coupon.php">Coupons Report</a>');
...
define("TABLE_HEADING_COUPON_DESCRIPTION","Description");
