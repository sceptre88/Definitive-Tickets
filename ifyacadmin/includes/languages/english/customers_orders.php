...
define('TEXT_IMPORTANT','<span class="red">IMPORTANT:</span> Use Box Office at the front-end to create orders or directly adjust orders Admin>Orders>Edit<br>How do we manage incoming orders? PLEASE <a target="_blank" href="https://www.osconcert.com/faq/index.php?solution_id=1064">VIEW FAQ</a><br><br>
If you see the plus sign <img src="images/icons/plus.gif"> You have customer comments click to see the order info.');
...
define('TABLE_HEADING_PURCHASER', 'Billing');
...
define('TEXT_COUPON' , 'Coupon Used: 1=true');
define('TEXT_CURRENT_STATUS','');
define('DOWNLOADS_ORDERS_STATUS_UPDATED_VALUE','');
define('TEXT_MODIFY_STATUS','');
?>