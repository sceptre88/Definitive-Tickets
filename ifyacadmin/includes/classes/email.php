...
//Read an HTML message body from an external file, convert referenced images to embedded,
		...
		if ($this->html && $this->html!=''){
          ...
          if (is_countable($this->smtp_attachments) && count($this->smtp_attachments)>0){
...
####### 2023 - this is a messy implementation a lot of the 
####### code in this {} section is repeated from the proevious
####### section - at some point it should be refactored
...
$mail->isMail();
//Set who the message is to be sent from
//$mail->setFrom($sender, 'First Last');
$mail->setFrom($from_addr, $from);
//Set an alternative reply-to address
//$mail->addReplyTo('replyto@example.com', 'First Last');
//Set who the message is to be sent to
