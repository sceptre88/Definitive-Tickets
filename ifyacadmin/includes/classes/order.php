...
defined('_FEXEC') or die(); 
  class order {
	...
	$ordered_product=""; 
      ...
      $order_query = tep_db_query("select * from " . TABLE_ORDERS . " o, " . TABLE_CUSTOMERS . " c where o.orders_id = '" . (int)$order_id . "' and o.customers_id=c.customers_id");
 ...
 function get_order_country_name($country_id) {
  ...
  function cart() {
	...
	'customer_email' => $billing_address['billin_email'],
							...
							'customer_phone' => $billing_address['customer_phone'],
