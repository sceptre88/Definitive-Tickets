...
{{VALUE_PRODUCT_FORM}}
<div id="template">
<section id="performance" data-aos="fade-up">
...
{{SECTION_IMAGE_END}}
    ...
    <div class="col-sm-9  mb-sm-0">
             ...
             <p class="mb-4">{{VALUE_PRODUCTS_DESCRIPTION}} </p>
            <div class="row">
				<div class="col-12">
					...
					<div class="col-md-12">
					<label class="col-12 col-form-label">{{VALUE_TEXT_PRODUCTS_QUANTITY}}</label>
					</div>
					<div class="col-12 col-lg-8 mb-5" style="border: 0px blue solid">
					<table id="gaq">
					<tr>
					<th>{{VALUE_ADD_QUANTITY_MINUS}}</th>
					<th>{{VALUE_LEFT_SYMBOL}}</th>
					<th>{{VALUE_PRODUCTS_QUANTITY}}</th>
