...
define('DIR_WS_TEMPLATE_IMAGES', 'templates/lightzone/images/');
...
$template_query = tep_db_query("select include_column_left,include_column_right from " . TABLE_TEMPLATE . "  WHERE template_name='lightzone'");
...
<head>
  ...
  <!-- RBE <link href="<?php echo DIR_WS_TEMPLATES . TEMPLATE_NAME; ?>/assets/vendor/aos/aos.css" rel="stylesheet"> -->
  ...
  <link href="<?php echo DIR_WS_TEMPLATES . TEMPLATE_NAME; ?>/assets/vendor/swiper/swiper-bundle.min.css" rel="stylesheet">
	...
	echo '<link href="templates/lightzone/flag-icon.css" rel="stylesheet">';
