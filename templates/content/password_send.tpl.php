...
defined('_FEXEC') or die();
	...
	echo tep_draw_form('password_send', tep_href_link(FILENAME_PASSWORD_SEND, 'action=process', 'SSL')); 
	?>
<?php
  if ($messageStack->size('password_send') > 0) 
  {
?>
      <div><?php echo $messageStack->output('password_send'); ?></div>
<?php
  }
?>
