...
<head>
	...
	<meta name="description" content="<?php //echo META_TAG_DESCRIPTION;?>IFYAC Online Ticket Sales">
	...
	<meta property="og:title" content="<?php //echo FB_TITLE; ?>Idaho Falls Youth Arts Centre">

	<meta property="og:description" content="<?php //echo FB_DESCRIPTION; ?>IFYAC Online Ticket Sales">

	<meta property="og:image" content="<?php //echo FB_IMAGE; ?>https://ifyac.definitivetickets.com/templates/lightzone/images/osconcert.png">
	...
	if(($current_category_id==2)or($current_category_id==58)or($current_category_id==114)or($current_category_id==170)or($current_category_id==226)or($current_category_id==332))
	...
	}elseif(($current_category_id==31)or($current_category_id==87)or($current_category_id==143)or($current_category_id==199)or($current_category_id==255)or($current_category_id==361))
	...
	div#ticket_discount{width: <?php echo POPUP_DISCOUNT_WIDTH;?>px!important;height: <?php echo POPUP_DISCOUNT_HEIGHT;?>px!important;}.main-content {padding-top: <?php echo HEADER_HEIGHT+20; ?>px;}#header .logo img{max-height: <?php 
...
<?php } ?>
	...
	<a href="<?php echo $_SERVER['REQUEST_URI'];?>#body" class="back-to-top d-flex align-items-center justify-content-center"><i class="bi bi-arrow-up-short"></i></a>
