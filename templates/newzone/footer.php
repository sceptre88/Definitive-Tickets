...
<!-- Copyright section of the footer-->
	...
	<div class="pull-right">&nbsp;<?php echo '<a href="'.tep_href_link(FILENAME_DEFAULT,'stcPath=2').'">'.BOX_INFORMATION_PRIVACY.'</a>';?> &nbsp;:: &nbsp;<?php echo '<a href="'.tep_href_link(FILENAME_DEFAULT,'stcPath=3').'">'.BOX_INFORMATION_CONDITIONS.'</a>';?> 
	<?php if(BOX_INFORMATION_CONTACT_LINK !=''){ 
	echo '&nbsp;:: &nbsp; <a href="' .BOX_INFORMATION_CONTACT_LINK. '">'.BOX_INFORMATION_CONTACT.'</a>';
	}
	?>  
	<?php 
	if (PURCHASE_NO_ACCOUNT =='no'){
	echo '&nbsp;:: &nbsp; <a href="'.tep_href_link(FILENAME_ACCOUNT).'">'.HEADER_ACCOUNT.'</a>';
	}else{
	echo '';	
	}
	?></div>
	...
	<!--Powered by <div class="credits"><a href="https://www.osconcert.com" target="_blank">osConcert</a></div>.-->
	</div>
	</footer><!-- #footer -->
<?php 
} 
