...
define('DIR_WS_TEMPLATE_IMAGES', 'templates/restaurantly/images/');
...
$template_query = tep_db_query("select include_column_left,include_column_right from " . TABLE_TEMPLATE . "  WHERE template_name='restaurantly'");
...
<head>
  ...
  <link href="https://fonts.googleapis.com/css?family=Open+Sans:300,300i,400,400i,600,600i,700,700i|Playfair+Display:ital,wght@0,400;0,500;0,600;0,700;1,400;1,500;1,600;1,700|Poppins:300,300i,400,400i,500,500i,600,600i,700,700i" rel="stylesheet">
	<!-- Libraries CSS Files -->
	<link href="<?php echo DIR_WS_TEMPLATES . TEMPLATE_NAME; ?>/assets/vendor/animate.css/animate.min.css" rel="stylesheet">
	...
	<style>.main-content {padding-top: <?php echo HEADER_HEIGHT-90; ?>px;}#header .logo img{max-height: <?php 
