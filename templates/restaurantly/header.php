...
if (DOWN_FOR_MAINTENANCE == 'true')
	...
	if(DOWN_FOR_MAINTENANCE_HEADER_OFF == 'false')
	{
		...
		?>
	<!-- ======= Header ======= -->
    <header id="header" class="header main-content fixed-top" data-scrollto-offset="0" style="height:<?php 
	...
	<?php
	echo "<li class=\"active\"><a href=\"" . tep_href_link(FILENAME_CHECKOUT_SHIPPING, '', 'SSL') . "\">" . HEADER_TITLE_CHECKOUT . '</a></li>' . "\n"; ?>
	<?php
	...
	<a href="featured_categories.php" class="book-a-table-btn scrollto d-none d-lg-flex"><?php echo HEADER_TEXT_BOOK; ?></a>
	</div><!-- .container -->
	</header><!-- #header -->
	<?php
