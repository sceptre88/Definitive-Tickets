...
?>
	...
	<div id="btnCheckOut" class="fixed-bottom" <?php echo $sign_up_style; ?>>
		...
		?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<?php echo '<a style="" title="' . IMAGE_BUTTON_CHECKOUT . '" href="' . tep_href_link(FILENAME_CHECKOUT_SHIPPING, '', 'SSL') . '">' . tep_template_image_button_checkout('', IMAGE_BUTTON_CHECKOUT) . '</a>'; 
		?></h2>
	</div>
	<?php
	}
