...
if (DOWN_FOR_MAINTENANCE == 'true')
	...
	<?php //use an image
	}else{ $url = '<a href="index.php">' . tep_image(DIR_WS_TEMPLATES . DEFAULT_TEMPLATE . '/' . DIR_WS_IMAGES . COMPANY_LOGO, STORE_NAME,HEADING_IMAGE_WIDTH,HEADING_IMAGE_HEIGHT) . '</a>';///STORE_NAME, '200', '60') ////
	echo $url;} ?></div>
	...
	echo "<li><a class=\"active\" href=\"" . tep_href_link(FILENAME_CHECKOUT_SHIPPING, '', 'SSL') . "\">" . HEADER_TITLE_CHECKOUT . '</a></li>' . "\n"; ?>
	<?php
	...
	<?php
		...
		echo '<br><br class="clearfloat"><br><br class="clearfloat"><br><br class="clearfloat">';
		}			
	}
} 
?>
