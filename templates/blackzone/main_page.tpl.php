<?php
/*
osConcert Visual Seat Reservation Copyright (c) 2009-2023 https://www.osconcert.com
Bootstrap v5 2023
*/
...
$template_query = tep_db_query("select include_column_left,include_column_right from " . TABLE_TEMPLATE . "  WHERE template_name='blackzone'");
