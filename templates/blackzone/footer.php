...
<!-- Copyright section of the footer-->
	...
	<div class="pull-right">&nbsp;<?php echo '<a href="'.tep_href_link(FILENAME_DEFAULT,'stcPath=2').'">'.BOX_INFORMATION_PRIVACY.'</a>';?> &nbsp;:: &nbsp;<?php echo '<a href="'.tep_href_link(FILENAME_DEFAULT,'stcPath=3').'">'.BOX_INFORMATION_CONDITIONS.'</a>';?> &nbsp;:: &nbsp;<?php echo '<a href="' .BOX_INFORMATION_CONTACT_LINK. '">'.BOX_INFORMATION_CONTACT.'</a>';?>  <?php 
