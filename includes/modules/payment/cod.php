...
// class constructor
	function __construct() {
		...
		define('MODULE_PAYMENT_COD_TEXT_TITLE',  '<span class="modname">' . $name . '</span>&nbsp;&nbsp;' . $image);
...
// class methods
    ...
    function install() {
      ...
      tep_db_query("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) values ('Image', 'MODULE_PAYMENT_COD_IMAGE', 'cod.png', 'Set the Image of payment module', '6', '8', 'tep_cfg_file_field(', now())");
   }
