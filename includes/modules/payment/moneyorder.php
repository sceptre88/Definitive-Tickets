...
// class constructor
	function __construct() {
		...
		$image = "";
		$path = "";
		if(defined('MODULE_PAYMENT_MONEYORDER_DISPLAY_NAME')){
			$name = MODULE_PAYMENT_MONEYORDER_DISPLAY_NAME;
		  }
		  if(defined('MODULE_PAYMENT_MONEYORDER_IMAGE')){
			$image = MODULE_PAYMENT_MONEYORDER_IMAGE;
		  }
		...
		define('MODULE_PAYMENT_MONEYORDER_TEXT_TITLE',  '<span class="modname">' . $name . '</span>&nbsp;&nbsp;' . $image);
...
// class methods
    ...
    function install() {
      ...
      tep_db_query("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) values ('Image', 'MODULE_PAYMENT_MONEYORDER_IMAGE', 'moneyorder.png', 'Set the Image of payment module', '6', '9', 'tep_cfg_file_field(', now())");
    }
