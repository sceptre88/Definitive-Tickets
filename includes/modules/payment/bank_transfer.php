...
// class constructor
	function __construct() {
		...
		//define what's not in the db
		define('MODULE_PAYMENT_BANK_TRANSFER_TEXT_TITLE',  '<span class="modname">' . $name . '</span>&nbsp;&nbsp;' . $image);		
...
// class methods
    ...
    function confirmation() {
      return array('title' => MODULE_PAYMENT_BANK_TRANSFER_TEXT );
    }
    ...
    function install() {
      ...
      tep_db_query("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, use_function, set_function, date_added) values ('Payment Zone', 'MODULE_PAYMENT_BANK_TRANSFER_ZONE', '1,2,3', 'If a zone is selected, only enable this payment method for that zone.', '6', '2', 'tep_get_zone_class_title', 'tep_cfg_pull_down_zone_classes(', now())");
      ...
      tep_db_query("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) values ('Image', 'MODULE_PAYMENT_BANK_TRANSFER_IMAGE', 'bank_transfer.png', 'Set the Image of payment module', '6', '13', 'tep_cfg_file_field(', now())");
