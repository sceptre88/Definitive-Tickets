...
defined('_FEXEC') or die();
  ...
  class ot_donation {
    ...
    function __construct() {
		...
		define("MODULE_ORDER_TOTAL_DONATION_STATUS", '');
		define("MODULE_ORDER_TOTAL_DONATION_SORT_ORDER", '');
		define("MODULE_ORDER_TOTAL_DONATION_INC_TAX", '');
		define("MODULE_ORDER_TOTAL_DONATION_INC_TAX", '');
		define("MODULE_ORDER_TOTAL_DONATION_CALC_TAX", '');
