...
defined('_FEXEC') or die();
  class ot_gv {
    ...
    function __construct() {
      $this->code = 'ot_gv';
	  define("MODULE_ORDER_TOTAL_GV_HEADER", '');
	  define("MODULE_ORDER_TOTAL_GV_DESCRIPTION", '');
	  define("MODULE_ORDER_TOTAL_GV_USER_PROMPT", '');
	  define("MODULE_ORDER_TOTAL_GV_STATUS", '');
	  define("MODULE_ORDER_TOTAL_GV_SORT_ORDER", '');
	  define("MODULE_ORDER_TOTAL_GV_INC_SHIPPING", '');
	  define("MODULE_ORDER_TOTAL_GV_INC_TAX", '');
	  define("MODULE_ORDER_TOTAL_GV_CALC_TAX", '');
	  define("MODULE_ORDER_TOTAL_GV_CREDIT_TAX", '');
	  define("MODULE_ORDER_TOTAL_GV_TAX_CLASS", '');
	  define("MODULE_ORDER_TOTAL_GV_REDEEM_BOX", '');
