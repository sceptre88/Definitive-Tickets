...
defined('_FEXEC') or die();
  ...
  class ot_qty_discount {
	...
	define('MODULE_ORDER_TOTAL_DISCOUNT_STATUS', '');
	define('MODULE_ORDER_TOTAL_DISCOUNT_SORT_ORDER', '');
	define('MODULE_ORDER_TOTAL_DISCOUNT_INC_SHIPPING', '');
	define('MODULE_ORDER_TOTAL_DISCOUNT_INC_TAX', '');
	define('MODULE_ORDER_TOTAL_DISCOUNT_CALC_TAX', '');
	define('MODULE_ORDER_TOTAL_DISCOUNT_RATE_TYPE', '');
	define('MODULE_ORDER_TOTAL_DISCOUNT_PERCENTAGE_TEXT_EXTENSION', '');
	define('MODULE_ORDER_TOTAL_DISCOUNT_FORMATED_TITLE', '');
	define('MODULE_ORDER_TOTAL_DISCOUNT_FORMATED_TEXT', '');
	define('MODULE_ORDER_TOTAL_DISCOUNT_DISABLE_WITH_COUPON', '');
	define('MODULE_ORDER_TOTAL_SERVICE_FEE_EXEMPT_CAT', '');
	define('MODULE_ORDER_TOTAL_DISCOUNT_RATES', '');
