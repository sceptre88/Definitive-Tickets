...
//Site thema configuration
  ...
  $configuration = tep_db_fetch_array($configuration_query);
	...
	define('TEMPLATE_STYLE', DIR_WS_TEMPLATES . TEMPLATE_NAME . "/css/main.css");
	}else{
	define('TEMPLATE_NAME', DEFAULT_TEMPLATE);
	define(TEMPLATE_STYLE, DIR_WS_TEMPLATES . DEFAULT_TEMPLATE . "/css/main.css");
	}
//:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
...
//:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
  ...
  $template = tep_db_fetch_array($template_query);
	...
	define('SHOW_FOOTER', $template['show_footer']); 
	define('HEADER_HEIGHT', $template['header_height']); 
	define('BOX_WIDTH_LEFT', $template['howto']); 
	...
	define('SHOW_LOGIN', $template['show_page_login']);
