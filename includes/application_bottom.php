...
// leave this code in this file
if( defined('GOOGLE_CAPTCHA_PUBLIC_KEY_V3') && tep_not_null(GOOGLE_CAPTCHA_PUBLIC_KEY_V3)){
	echo ' <script src="https://www.google.com/recaptcha/api.js?render='.GOOGLE_CAPTCHA_PUBLIC_KEY_V3.'" async defer></script>';// async defer>
}elseif( defined('GOOGLE_CAPTCHA_PUBLIC_KEY_V2') && tep_not_null(GOOGLE_CAPTCHA_PUBLIC_KEY_V2)){
