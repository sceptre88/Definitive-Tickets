...
define('BOX_HEADING_SHOPPING_CART', 'Refund Ticket Order');
...
define('YELLOW','<strong> </strong> ');
define('BLUE','<strong> </strong> ');
define('GREEN','<strong> </strong> ');
define('FUCHSIA','<strong> </strong> ');
define('RED','<strong> </strong> ');
define('SKYBLUE','<strong> </strong> ');
define('PALEGREEN','<strong> </strong> ');
define('ORANGE','<strong> </strong> ');
define('THISTLE','<strong> </strong> ');
define('TEAL','<strong> </strong> ');
define('SALMON','<strong> </strong> ');
...
define('TEXT_TRANSACTION_BARRED','Transaction Barred');
define('TEXT_TRANSACTION_BARRED_REASON','Reason: The country you are in %s, is not the same as your account address.');
...
//GDPR May 25th 2018
define('TEXT_COOKIES','We use cookies to track usage and preferences. <a href="https://en.wikipedia.org/wiki/HTTP_cookie">Learn more</a>');//message
...
define('TEXT_TIME_NOW', 'Time now is:');
...
define('HEADER_TEXT_HOME', 'Home');
define('HEADER_TEXT_ABOUT', 'About');
define('HEADER_TEXT_MENU', 'Menu');
define('HEADER_TEXT_SPECIALS', 'Specials');
define('HEADER_TEXT_EVENTS', 'Events');
define('HEADER_TEXT_CHEFS', 'Chefs');
define('HEADER_TEXT_GALLERY', 'Gallery');
define('HEADER_TEXT_BOOK', 'Book a table');

define('HEADERBAR_TEXT_1', 'Welcome to ');
define('HEADERBAR_TEXT_2', 'Delivering great food for more than 18 years! ');
define('HEADERBAR_TEXT_3', 'Our Menu');
define('HEADERBAR_TEXT_4', 'Book a Table');

define('TEXT_GET_TICKETS', 'Get Tickets');

define('TEXT_TICKETHOLDER', 'Ticket Holder Name');
define('TICKETHOLDER_NAME', 'Ticket Holder Name');

define('TEXT_NO_BO_DESIGN', 'Not available in Design Mode - please disable designer mode in your Box Office settings to use the Box Office blocker view.');

define('TEXT_FOOTER_NAME', STORE_NAME); 
define('TEXT_FOOTER_DETAILS', STORE_NAME_ADDRESS); 
define('FOOTER_TEXT_EMAIL', 'Email');
define('TEXT_FOOTER_LINKS', 'Useful Links'); 
define('TEXT_FOOTER_SERVICES', 'Our Services'); 
define('TEXT_FOOTER_NEWSLETTER', 'Join Our Newsletter'); 
define('TEXT_FOOTER_NEWSLETTER_DESC', 'Sign up for our latest NEWS'); 

define('COUPON_DISCOUNT','Coupon Discount');
define("TEXT_FOR"," for: ");
define('TEXT_CONFIRM_CONDITIONS','Write some more conditions here');
define('TEXT_GV_BOOKINGS','Gift Order: ');

define('TEXT_DOWNLOAD_NAME', 'Name');
define('TEXT_DOWNLOAD_EXPIRY', 'Download Expiry Date');
define('TEXT_DOWNLOAD_REMAINING', 'Download Remaining');
define('TEXT_DOWNLOAD_SIZE', 'Size(KB)');
define('TEXT_DOWNLOAD', 'Download ');

define('TEXT_ORDERED_ERROR', 'ERROR: One or more of your ticket selections are NOT available. Please inform the store owner.');

define('COOKIEHUB_KEY', '');

define('TEXT_TICKETS_REMAINING', 'There are tickets remaining for this event.');
define('TEXT_NO_DETAILS_FOUND', 'No Details Found or this product is NOT printable');
define('TEXT_DATE', 'Date:');
define('TEXT_TICKETS_CLOSED', 'Tickets are closed');
define('TEXT_TICKETS_CLOSED_AT', 'Ticket sales will close at:');

define('NEWSLETTER_LANDING_PAGE', 'https://landing.mailerlite.com/webforms/landing/a8f2m5');
define('OTHER_FOOTER_TEXT2', 'This is some <h2>Alt Text </h2>');
