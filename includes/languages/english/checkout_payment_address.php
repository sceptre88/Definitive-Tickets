...
define('TEXT_SELECTED_PAYMENT_DESTINATION', 'This is the currently selected billing address where the invoice/tickets to this order will be delivered to.');
define('TEXT_SELECTED_PAYMENT_ADDRESS', 'This is the current account billing address for this order.');
...
define('ENTRY_STATE_ERROR_SELECT2', 'Error');
