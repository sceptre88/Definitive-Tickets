...
define('SHOW_ALL_ORDERS', 'Show All');
define('OVERVIEW_SHOW_ALL_ORDERS', '(show all orders)');
define('OVERVIEW_PREVIOUS_ORDERS', 'Previous Orders');

define('MY_ACCOUNT_CURRENT_PURCHASES','Current Purchases');
define('MY_ACCOUNT_TITLE', 'Personal Details');
...
define('MY_ORDERS_TITLE', 'Order History');
...
define('TEXT_NO_ITEMS','No Items found');

define('TEXT_PRODUCT','Ticket');
define('TEXT_ALL','(show all)');

define('MY_ACCOUNT_SEASON','Season Ticket');
define('MY_ACCOUNT_SEASON_TEXT','You currently have %s ticket(s) available.');

//GDPR May 25th 2018
define('MY_ACCOUNT_CLOSE','Please close my account. (Forget Me)');
define ('MY_ACCOUNT_DATA', 'GDPR Personal Data Request');
define ('MY_ACCOUNT_DELETE', 'GDPR - request to delete all personal data');

define('MODULE_ORDER_TOTAL_GV_STATUS','false');
?>