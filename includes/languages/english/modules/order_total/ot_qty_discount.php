...
defined('_FEXEC') or die();
		...
		define('MODULE_ORDER_TOTAL_DISCOUNT_TAX_CLASS', '');
  ...
  define('MODULE_ORDER_TOTAL_DISCOUNT_FORMATED_TITLE', '<strong>Quantity Discount %s:</strong>'); // %s is the placement of the MODULE_ORDER_TOTAL_DISCOUNT_PERCENTAGE_TEXT_EXTENSION
