...
defined('_FEXEC') or die();
	...
	define('SUMME','');
	define('MODULE_PAYMENT_BANK_TRANSFER_TEXT','');
	define("MODULE_PAYMENT_BANK_TRANSFER_SORT_ORDER", '');
	define("MODULE_PAYMENT_BANK_TRANSFER_STATUS", '');
	define("MODULE_PAYMENT_BANK_TRANSFER_ORDER_STATUS_ID", '');
	...
	// <td><strong>Sort Code.: </strong></td><td>&nbsp;&nbsp;" . MODULE_PAYMENT_BANK_TRANSFER_BIC . "</td></tr><tr>
	...
	//Below is the short version of the above message at the Payment Method Page
	
	define('MODULE_PAYMENT_BANK_TRANSFER_TEXT', "<div class=\"bank-transfer-text\">Bank Transfer Details will be sent by email for a successful reservation.</div>");
	...
	<b>Sort Code: </b>' . MODULE_PAYMENT_BANK_TRANSFER_BIC . '<br>
	...
	//Jan 2022 Now add another Placeholder %%Reference_ID%% with %%Order_Number%%
	define('TEXT_REFERENCEID',' Please use this reference when making your deposit. Your Reference Id = ');
