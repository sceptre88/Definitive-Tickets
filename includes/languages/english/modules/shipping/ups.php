...
define('MODULE_SHIPPING_UPS_EXCEPT_COUNTRY','');
define('MODULE_SHIPPING_UPS_EXCEPT_ZONE','');
define('MODULE_SHIPPING_UPS_ZONE','');
define('MODULE_SHIPPING_UPS_STATUS','');
define('MODULE_SHIPPING_UPS_TAX_CLASS','');
define('MODULE_SHIPPING_UPS_SORT_ORDER','');
