...
define ('PDF_VOUCHERS','PDF Vouchers For Printing');
define ('GET_VOUCHERS_HERE','GET VOUCHERS HERE');
define ('PRINT_PDF_VOUCHERS','Print PDF Vouchers');
define ('PDF_VOUCHER_LINK','To download and print your PDF Vouchers, click <a title="Click here To download and print your PDF Vouchers" href="%s"  target="_blank">here</a>');
?>
