...
defined('_FEXEC') or die();
  ...
  define('FILENAME_ACCOUNT_PDF','account_ticket.php');
  define('FILENAME_VOUCHER_PDF','voucher_ticket.php');
  ...
  define('CONTENT_PASSWORD_SEND', 'password_send');
...
// define the filenames used in the project
 ...
 // define('FILENAME_ALSO_PURCHASED_PRODUCTS', CONTENT_ALSO_PURCHASED_PRODUCTS . '.php');
  ...
  define('FILENAME_PASSWORD_SEND', CONTENT_PASSWORD_SEND . '.php');
