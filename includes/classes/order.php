...
defined('_FEXEC') or die();
 ...
 $orders_products_query = tep_db_query("select * from " . TABLE_ORDERS_PRODUCTS . " where orders_id = '" . (int)$order_id . "' order by products_id DESC");
	...
	$shipping_address_query = tep_db_query("select ab.entry_firstname, ab.entry_lastname, ab.entry_company, ab.entry_customer_email,ab.entry_customer_phone,ab.entry_street_address, ab.entry_suburb, ab.entry_postcode, ab.entry_city, ab.entry_zone_id, z.zone_name, ab.entry_country_id, c.countries_id, c.countries_name, c.countries_iso_code_2, c.countries_iso_code_3, c.address_format_id, ab.entry_state from " . TABLE_ADDRESS_BOOK . " ab left join " . TABLE_ZONES . " z on (ab.entry_zone_id = z.zone_id) left join " . TABLE_COUNTRIES . " c on (ab.entry_country_id = c.countries_id) where ab.customers_id = '" . (int)$FSESSION->get('customer_id') . "' and ab.address_book_id = '" . (int)$FSESSION->get('sendto') . "'");
	...
	{
	$tax_address_query = tep_db_query("select ab.entry_country_id, ab.entry_zone_id from " . TABLE_ADDRESS_BOOK . " ab left join " . TABLE_ZONES . " z on (ab.entry_zone_id = z.zone_id) where ab.customers_id = '" . (int)$FSESSION->get('customer_id') . "'");
	}else{
	...
	$this->delivery = array(
							...
							'customer_phone' => $shipping_address['entry_customer_phone'],
	...
	$this->billing = array(
							...
							'customer_phone' => $billing_address['entry_customer_phone'],
	...
	for ($i=0, $n=sizeof($products); $i<$n; $i++) 
	{
		...
		$this->products[$index] = array(
								...
								'section_id' => $products[$i]['section_id'],
