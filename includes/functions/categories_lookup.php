...
function categories_lookup($new = null)
	{
	...
	$heading_categories_description=tep_get_categories_description($cat_id);
		...
		$heading_name = tep_get_categories_name($target_id);
		$heading_venue = tep_get_categories_venue($target_id);
		$categories_date = tep_get_categories_date($target_id);
		$categories_time = tep_get_categories_time($target_id);
