...
// Output a form
	...
	// function tep_draw_contact_form($name, $action, $method = 'post', $parameters = '') 
	// {
		// global $FREQUEST,$FSESSION;
		// $form = '<form name="' . tep_output_string($name) . '" action="' . tep_output_string($action) . '" method="' . tep_output_string($method) . '"  autocomplete="off" data-recaptcha-site-key='.CAPTCHA_SECRET_KEY.'';
...
// Output a selection field - alias function for tep_draw_checkbox_field() and tep_draw_radio_field()
  function tep_draw_selection_field($name, $type, $value = '', $checked = false, $parameters = '') 
  {
   ...
   function tep_draw_selection_field2($name, $type, $value = '', $checked = false, $parameters = '') 
  {
    $selection = '<input style="margin-left:-85px" type="' . tep_output_string($type) . '" name="' . tep_output_string($name) . '" ';
...
// Output a form checkbox field
  ...
  // Output a form checkbox field
  function tep_draw_checkbox_field2($name, $value = '', $checked = false, $parameters = '') {
    return tep_draw_selection_field2($name, 'checkbox', $value, $checked, $parameters);
  }
