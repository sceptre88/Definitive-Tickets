...
#####################################################
#    include page title moved up here so that seatplan_ajax
#    returns false before any database queries
#    2023: seatplan_ajaz does not seem to trigger
#    as whos_online now moved to breadcrumbs only
#####################################################
	if ($title==''){
...
#################### end #############################
	...
	//$xx_mins_ago = (time() - SEATPLAN_TIMEOUT + 60);
