...
define('HEADING_TITLE_DELETE_ENTRY', '');
define('HEADING_TITLE_ADD_ENTRY', '');
define('DELETE_ADDRESS_TITLE', '');
...
//        exit;
	...
	if ($address_book_id!='' && is_numeric($address_book_id)) {
		$entry_query = tep_db_query("select entry_gender, entry_company, entry_firstname, entry_lastname, entry_street_address, entry_suburb, entry_customer_email, entry_customer_phone, entry_postcode, entry_city, entry_state, entry_zone_id, entry_country_id from " . TABLE_ADDRESS_BOOK . " where customers_id = '" . (int)$FSESSION->customer_id . "' and address_book_id = '" . (int)$address_book_id . "'");
