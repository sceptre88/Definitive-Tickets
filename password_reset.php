...
define('ERR_PWD_EMPTY', '');
define('CONTENT_ACCOUNT_PASSWORD', '');
define('ERR_PWD_ALPHANUMERIC', '');
define('ERR_NEW_PWD_EMPTY', '');
define('ERR_NEW_PWD_ALPHANUMERIC', '');
define('ERR_NEW_PWD_ALPHA_SYMBOLS', '');
define('ERR_PWD_ALPHA_SYMBOLS', '');
define('ENTRY_EVENT_DATE_OF_BIRTH_ERROR', '');
define('ENTRY_MOBILE_NUMBER_ERROR', '');
define('HIDE_CUSTOMER_OCCUPATION_FRONT', '');
define('ENTRY_OCCUPATION_ERROR', '');
define('ENTRY_SOURCE_ERROR', '');
define('HIDE_CUSTOMER_INTEREST_FRONT', '');
define('ENTRY_INTEREST_ERROR', '');
define('ENTER_CURRENT_PASSWORD', '');
define('ENTER_NEW_PASSWORD', '');
define('ENTRY_SECOND_EMAIL_ADDRESS_ERROR', '');
define('ENTRY_SECOND_CONFIRM_EMAIL_ADDRESS_ERROR', '');
define('ENTRY_USERNAME_ERROR', '');
define('ENTRY_CONFIRM_EMAIL_ADDRESS_ERROR', '');
define('JS_SECOND_EMAIL_ADDRESS_UNIQUE', '');
define('ENTER_PASSWORD_CONFIRMATION', '');
