...
// both these session values applied in the next block of text
	...
	from " . TABLE_ORDERS . " o, " . TABLE_ORDERS_PRODUCTS . " op, " . TABLE_CUSTOMERS . " c, " . TABLE_CUSTOMERS_TO_CUSTOMERS ." c2c ".
				" where o.customers_id=c2c.group_customer_id and c2c.customer_id=c.customers_id and c2c.orders_id=o.orders_id and o.orders_id in(" . $order_ids . ") and o.orders_id=op.orders_id and op.is_printable = 1" . " and op.products_sku !='6' order by c.customers_id,o.orders_id,op.products_name";
	...
	{ // ??...and op.support_packs_type !='B'
		...
		from " . 
					...
					" and op.products_sku !='6' order by o.orders_id,op.products_name";
	...
	}else
	{
		...
		$pdf->AddFont('DejaVu','B','DejaVuSansCondensed-Bold.ttf',true);
		$pdf->SetFont('DejaVu','B',15); //13
		$pdf->Text(5,5,TEXT_NO_DETAILS_FOUND);
	}
