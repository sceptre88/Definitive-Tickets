...
define('FILENAME_CHECKOUT_PROCESS_FREE', '');
define('FILENAME_CHECKOUT_PAYMENT', '');
define('MODULE_ORDER_TOTAL_SHIPPING_FREE_SHIPPING', '');
define('MODULE_ORDER_TOTAL_SHIPPING_DESTINATION', '');
define('MODULE_ORDER_TOTAL_SHIPPING_FREE_SHIPPING_OVER', '');
define('NO_CHECKOUT_ZERO_PRICE', '');
...
//	so we add a little test here for that and, if too many tickets bounce them to the shopping cart page with a message
	...
	//PHP8
	if (is_countable($quotes_available) && count($quotes_available)>0){
