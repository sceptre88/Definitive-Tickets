...
//PHP8 if (ENFORCED_COUPON == 'yes'  &&  count($_SESSION['coupon_codes']) == 0) {
if ((ENFORCED_COUPON == 'yes')  && (is_countable($_SESSION['coupon_codes']) && count($_SESSION['coupon_codes'])>0)){	
...
//2012 changes by Graeme
		if($_SESSION['credit_covers']=='valid'){//enough credit to cover the purchase
			...
			define('MODULE_PAYMENT_FREE_STATUS','False');
