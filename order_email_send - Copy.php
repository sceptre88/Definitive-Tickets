...
//------insert customer choosen option eof ----
		...
		<td width="10%" style="vertical-align: text-top;text-align:left">
		'.$currencies->display_price($order->products[$i]['final_price'], $order->products[$i]['tax'], $order->products[$i]['qty'],false).'
		</td>
		</tr>
		<tr>
...
//==============================================
	...
	$merge_details[BILL_PH]=$order->billing['billing_phone'];
	...
	$merge_details[DELI_PH]=$order->billing['delivery_phone'];
