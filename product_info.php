...
define('SECTION_NO_PRODUCT', '');
define('SECTION_PRODUCT', '');
define('TPL_CONTENT', '');
define('DIR_WS_TEMPLATES', '');
define('TEMPLATE_NAME', '');
define('CONTENT_PRODUCT_INFO', '');
define('PRODUCT_ID', '');
define('PRODUCT_STOCK', '');
define('PRODUCT_PRICE_BREAKS', '');
define('CURRENCY_DETAIL', '');
define('PRICE_CALC_FUNCTIONS', '');
define('TEXT_ERR_EMAIL_ADDRESS', '');
define('SALEMAKER_DATAS', '');
define('TABLE_CATEGORIES_DESCRIPTION', '');
define('VALUE_GA_TOTAL', '');
define('VALUE_GA_QTY', '');
define('HEADER_COLS_MULTIPLE_IMAGE', '');
define('SECTION_MULTIPLE_IMAGE', '');
define('VALUE_FIRST_IMAGE', '');
define('VALUE_FIRST_IMAGE_TITLE', '');
define('SECTION_PRODUCTS_PRICE_BREAK', '');
define('SECTION_PRODUCTS_PRICE', '');
define('VALUE_LEFT_SYMBOL', '');
define('VALUE_RIGHT_SYMBOL', '');
define('VALUE_PRODUCTS_PRICE_BREAK_HEADING', '');
define('TEXT_VALUE_PRODUCTS_PRICE_BREAK_HEADING', '');
define('VALUE_PRODUCTS_PRICE_BREAK_BUY', '');
define('TEXT_VALUE_PRODUCTS_PRICE_BREAK_BUY', '');
define('VALUE_PRODUCTS_PRICE_BREAK_SAVE', '');
define('TEXT_VALUE_PRODUCTS_PRICE_BREAK_SAVE', '');
define('VALUE_PRODUCTS_PRICE_BREAK_EACH', '');
define('TEXT_VALUE_PRODUCTS_PRICE_BREAK_EACH', '');
define('REPEAT_PRODUCTS_PRICE_BREAK', '');
define('VALUE_PRICE_BREAK_QUAN', '');
define('VALUE_PRICE_BREAK_PRICE', '');
define('VALUE_INPUT_QUAN', '');
define('VALUE_PRODUCTS_PRICE', '');
define('VALUE_TEXT_PRODUCTS_QUANTITY', '');
define('TEXT_VOUCHER_VALUE', '');
define('VALUE_PRODUCTS_QUANTITY', '');
define('VALUE_ADD_QUANTITY_MINUS', '');
define('VALUE_ADD_QUANTITY_PLUS', '');
define('VALUE_CHECKOUT', '');
define('VALUE_FAMILY_QUANTITY', '');
define('VALUE_ADD_QUANTITY', '');
define('SECTION_PRODUCTS_SALEMAKER', '');
define('VALUE_SELECT_SALEMAKER_DISCOUNT', '');
define('TEXT_SELECT_SALEMAKER_DISCOUNT', '');
define('TEXT_NO_DISCOUNT', '');
define('REPEAT_PRODUCTS_SALEMAKER', '');
define('VALUE_PRODUCTS_NAME', '');
define('VALUE_PRODUCTS_DESCRIPTION', '');
define('VALUE_EXTRA_MODULES', '');
define('TEXT_PRICES_FROM', '');
define('SECTION_ORIGINAL_HEAD', '');
define('VALUE_CATEGORIES_START', '');
define('VALUE_CATEGORIES_NAME', '');
define('VALUE_CATEGORIES_TITLE', '');
define('VALUE_CATEGORIES_VENUE', '');
define('VALUE_CATEGORIES_DATE', '');
define('VALUE_CATEGORIES_TIME', '');
define('VALUE_CATEGORIES_DESC', '');
define('VALUE_CATEGORIES_END', '');
define('VALUE_HEAD_PRICE', '');
define('VALUE_TABLE_HEAD_FIRST', '');
define('VALUE_TABLE_HEAD_LAST', '');
define('VALUE_PRODUCTS_URL', '');
define('VALUE_BUTTON_CONT', '');
define('VALUE_BUTTON_CART', '');
define('VALUE_TOTAL_PRICE', '');
define('TEXT_TOTAL_PRICE', '');
define('VALUE_STOCK_OUT', '');
define('TEXT_OUT_STOCK', '');
define('VALUE_STOCK_OUT_DETAILS', '');
define('TEXT_OUT_STOCK_DETAILS', '');
define('VALUE_PRODUCT_FORM', '');
define('VALUE_HIDDEN_VALUES', '');
define('VALUE_LOAD_MSG_QUAN', '');
define('VALUE_LOAD_MSG_ATTR', '');
define('TEXT_CHECK_STOCK', '');
define('SOLD_OUT_MESSAGE', '');
define('VALUE_PRODUCT_NOT_FOUND', '');
define('TEMPLATENAME_MAIN_PAGE', '');
define('PRICE_CALC_FUNCTIONS', '');
	...
	if(($categories['categories_status']==1)or($_SESSION['BoxOffice']== 999)or($_SESSION['customer_country_id']==999))
	{
		...
		if(!strtotime($concert_time))
		{
			...
			if (count($images)>1)
			{
				...
				if(file_exists(DIR_FS_CATALOG . DIR_WS_IMAGES . "big/" .$first_image)){
					...
					//2024 pop up image
					$temp='<a target="_blank" href="' . DIR_WS_IMAGES . $first_image . '"  class="glightbox"><img class="img-fluid" src="' . DIR_WS_IMAGES . $first_image . '" id="imgContainer"></a>';
				}
		...
		//	{
				...
				if (($product_info['product_type'] == 'G')
					...
					or($product_info['product_type'] == 'X')) 
					{
						if(ALT_GA_TEMPLATE=='yes')
						{
							...
							$tpl["VALUE_PRODUCTS_QUANTITY"]= tep_draw_input_field('qty',1,'id="qty" style="margin:16px 0 0 0;padding:0px; text-align: center;min-width:50px;min-height:42px" size="3" onfocus="this.value=\'\';" onBlur="javascript:checkStock(\'\');" onKeyDown="javascript:return numericOnly(event);"');
					...
					{
							//osconcert shows no quantity box
							$tpl["VALUE_TEXT_PRODUCTS_QUANTITY"]='';
							$tpl["VALUE_ADD_QUANTITY_PLUS"]='';
							$tpl["VALUE_ADD_QUANTITY_MINUS"]='';
			...
			##################################################################
			//osconcert add checkout button and continue shopping button
